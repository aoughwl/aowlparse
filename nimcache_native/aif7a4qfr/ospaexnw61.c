...
typedef struct X60Qt_0_IAtupleAiS64ZAiS64_ospaexnw61{
  NI64 fld_0;
  NI64 fld_1;}
X60Qt_0_IAtupleAiS64ZAiS64_ospaexnw61;
...
NB8 X60QiniGuard_0_ospaexnw61;
static inline void dec_0_Iw9ew8i1_ospaexnw61(NI64* x_7, NI64 y_3){
  (*x_7) = ((NI64)((*x_7) - y_3));}
void X60Qini_0_ospaexnw61(void){
  if (X60QiniGuard_0_ospaexnw61){
    return;}
  X60QiniGuard_0_ospaexnw61 = NIM_TRUE;
  X60Qini_0_sysvq0asl();
  X60Qini_0_str7j0ifg();
  X60Qini_0_osezuyu63();
