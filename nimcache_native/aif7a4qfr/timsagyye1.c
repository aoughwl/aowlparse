...
typedef NU8 Month_0_timsagyye1;

#define mJan_0_timsagyye1 ((NU8)IL64(1))
#define mFeb_0_timsagyye1 ((NU8)IL64(2))
#define mMar_0_timsagyye1 ((NU8)IL64(3))
#define mApr_0_timsagyye1 ((NU8)IL64(4))
#define mMay_0_timsagyye1 ((NU8)IL64(5))
#define mJun_0_timsagyye1 ((NU8)IL64(6))
#define mJul_0_timsagyye1 ((NU8)IL64(7))
#define mAug_0_timsagyye1 ((NU8)IL64(8))
#define mSep_0_timsagyye1 ((NU8)IL64(9))
#define mOct_0_timsagyye1 ((NU8)IL64(10))
#define mNov_0_timsagyye1 ((NU8)IL64(11))
#define mDec_0_timsagyye1 ((NU8)IL64(12))
typedef NU8 WeekDay_0_timsagyye1;

#define dMon_0_timsagyye1 ((NU8)IL64(0))
#define dTue_0_timsagyye1 ((NU8)IL64(1))
#define dWed_0_timsagyye1 ((NU8)IL64(2))
#define dThu_0_timsagyye1 ((NU8)IL64(3))
#define dFri_0_timsagyye1 ((NU8)IL64(4))
#define dSat_0_timsagyye1 ((NU8)IL64(5))
#define dSun_0_timsagyye1 ((NU8)IL64(6))
typedef struct Time_0_timsagyye1{
  NI64 seconds_0;
  NI32 nanosecond_0;}
Time_0_timsagyye1;
typedef struct Duration_0_timsagyye1{
  NI64 seconds_0;
  NI32 nanosecond_0;}
Duration_0_timsagyye1;
typedef struct DateTime_0_timsagyye1{
  NI64 year_0;
  Month_0_timsagyye1 month_0;
  NI32 monthday_0;
  NI32 hour_0;
  NI32 minute_0;
  NI32 second_0;
  NI32 nanosecond_0;
  WeekDay_0_timsagyye1 weekday_0;
  NI32 yearday_0;}
DateTime_0_timsagyye1;
typedef struct X60Qt_0_IAtupleAiS64ZAiS64ZAiS64_timsagyye1{
  NI64 fld_0;
  NI64 fld_1;
  NI64 fld_2;}
X60Qt_0_IAtupleAiS64ZAiS64ZAiS64_timsagyye1;
typedef struct X60Qt_0_IAarrayAiS32ZS12_timsagyye1{
  NI32 a[IL64(12)];}
X60Qt_0_IAarrayAiS32ZS12_timsagyye1;
extern void X60Qini_0_sysvq0asl(void);
extern void X60Qini_0_str7j0ifg(void);
extern void X60Qini_0_pososrh1q1(void);
NB8 X60QiniGuard_0_timsagyye1;
void X60Qini_0_timsagyye1(void){
  if (X60QiniGuard_0_timsagyye1){
    return;}
  X60QiniGuard_0_timsagyye1 = NIM_TRUE;
  X60Qini_0_sysvq0asl();
  X60Qini_0_str7j0ifg();
