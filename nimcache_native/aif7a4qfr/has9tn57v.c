...
LongString_0_sysvq0asl const strlit_0_I14694606176902936784_has9tn57v = {
  .fullLen_0 = IL64(92), .rc_0 = IL64(0), .capImpl_0 = IL64(0), .data_0 = "../nimony/lib/std/system/openarrays.nim(10, 49): 0 <= idx and idx < x.len [AssertionDefect]\012"}
;
NB8 X60QiniGuard_0_has9tn57v;
...
static inline NC8* getQ_10_I5nt6we_has9tn57v(openArray_0_Ijk0jkw1_has9tn57v x_14, NI64 idx_1){
  ...
  return result_19;}
void X60Qini_0_has9tn57v(void){
  if (X60QiniGuard_0_has9tn57v){
    return;}
  X60QiniGuard_0_has9tn57v = NIM_TRUE;
  X60Qini_0_sysvq0asl();}
