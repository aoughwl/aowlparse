...
string_0_sysvq0asl;
typedef struct X60Qt_0_IAarraySstring0sysvq0aslS4_osalirkw71{
  string_0_sysvq0asl a[IL64(4)];}
X60Qt_0_IAarraySstring0sysvq0aslS4_osalirkw71;
...
static inline string_0_sysvq0asl* getQ_10_Ik9hgkq1_osalirkw71(openArray_0_Ig73pnk_osalirkw71 x_4, NI64 idx_1){
  ...
  return result_10;}
void X60Qini_0_osalirkw71(void){
  if (X60QiniGuard_0_osalirkw71){
    return;}
  X60QiniGuard_0_osalirkw71 = NIM_TRUE;
  X60Qini_0_sysvq0asl();
