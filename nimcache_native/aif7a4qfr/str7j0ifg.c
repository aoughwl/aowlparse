...
typedef struct X60Qt_0_IAtupleSstring0sysvq0aslSR6_ospaexnw61 X60Qt_0_IAtupleSstring0sysvq0aslSR6_ospaexnw61;
typedef struct X60Qt_0_IAtupleAsetAcS8ZZAcS8_str7j0ifg X60Qt_0_IAtupleAsetAcS8ZZAcS8_str7j0ifg;
typedef struct LongString_0_sysvq0asl LongString_0_sysvq0asl;
typedef NU8 FloatFormatMode_0_str7j0ifg;

#define ffDefault_0_str7j0ifg ((NU8)IL64(0))
#define ffDecimal_0_str7j0ifg ((NU8)IL64(1))
#define ffScientific_0_str7j0ifg ((NU8)IL64(2))
typedef NU8 BinaryPrefixMode_0_str7j0ifg;

#define bpIEC_0_str7j0ifg ((NU8)IL64(0))
#define bpColloquial_0_str7j0ifg ((NU8)IL64(1))
...
typedef struct openArray_0_Ihfaw761_str7j0ifg{
  X60Qt_0_IAtupleSstring0sysvq0aslSR6_ospaexnw61* a_0;
  NI64 len_0;}
openArray_0_Ihfaw761_str7j0ifg;
typedef struct openArray_0_Ijk0jkw1_has9tn57v{
  NC8* a_0;
  NI64 len_0;}
openArray_0_Ijk0jkw1_has9tn57v;
typedef struct openArray_0_I8ohqne_str7j0ifg{
  X60Qt_0_IAtupleAsetAcS8ZZAcS8_str7j0ifg* a_0;
  NI64 len_0;}
openArray_0_I8ohqne_str7j0ifg;
...
typedef struct X60Qt_0_IAarrayAiS64ZS256_str7j0ifg{
  NI64 a[IL64(256)];}
X60Qt_0_IAarrayAiS64ZS256_str7j0ifg;
typedef struct string_0_sysvq0asl{
  NU64 bytes_0;
  LongString_0_sysvq0asl* more_0;}
string_0_sysvq0asl;
typedef struct X60Qt_0_IAtupleSstring0sysvq0aslSR6_ospaexnw61{
  string_0_sysvq0asl fld_0;
  string_0_sysvq0asl fld_1;}
X60Qt_0_IAtupleSstring0sysvq0aslSR6_ospaexnw61;
typedef struct X60Qt_0_IAtupleAsetAcS8ZZAcS8_str7j0ifg{
  X60Qt_0_IAarrayAuS8ZS32_cmdqs323n1 fld_0;
  NC8 fld_1;}
X60Qt_0_IAtupleAsetAcS8ZZAcS8_str7j0ifg;
...
typedef struct X60Qt_0_IAarrayAcS8ZS3_str7j0ifg{
  NC8 a[IL64(3)];}
X60Qt_0_IAarrayAcS8ZS3_str7j0ifg;
typedef struct X60Qt_0_IAarrayAcS8ZS6_str7j0ifg{
  NC8 a[IL64(6)];}
X60Qt_0_IAarrayAcS8ZS6_str7j0ifg;
typedef struct X60Qt_0_IAarrayAcS8ZS2501_str7j0ifg{
  NC8 a[IL64(2501)];}
X60Qt_0_IAarrayAcS8ZS2501_str7j0ifg;
typedef struct X60Qt_0_IAarraySstring0sysvq0aslS7_str7j0ifg{
  string_0_sysvq0asl a[IL64(7)];}
X60Qt_0_IAarraySstring0sysvq0aslS7_str7j0ifg;
...
typedef struct X60Qt_0_IAarrayAtupleAsetAcS8ZZAcS8ZZS4_str7j0ifg{
  X60Qt_0_IAtupleAsetAcS8ZZAcS8_str7j0ifg a[IL64(4)];}
X60Qt_0_IAarrayAtupleAsetAcS8ZZAcS8ZZS4_str7j0ifg;
...
LongString_0_sysvq0asl const strlit_0_I14872370265633446329_str7j0ifg = {
  .fullLen_0 = IL64(88), .rc_0 = IL64(0), .capImpl_0 = IL64(0), .data_0 = "../nimony/lib/std/system/openarrays.nim(12, 59): 0 <= i and i < x.len [AssertionDefect]\012"}
;
NB8 X60QiniGuard_0_str7j0ifg;
string_0_sysvq0asl dollarQ_0_str7j0ifg(NC8* x_1){
  string_0_sysvq0asl result_12;
  nimStrWasMoved((&result_12));
  if (((void*)x_1) == NIM_NIL){
    nimStrDestroy(result_12);
    result_12 = (string_0_sysvq0asl){
      .bytes_0 = 0ull, .more_0 = NIM_NIL}
    ;}
  else {
    NI64 X60Qx_49 = strlen(x_1);
    NI64 L_0 = ((NI64)X60Qx_49);
    nimStrDestroy(result_12);
    string_0_sysvq0asl X60Qx_50 = newString_0_sysvq0asl(L_0);
    result_12 = X60Qx_50;
    {
      NI64 X60Qlf_11 = IL64(0);
      NI64 X60Qlf_12 = len_4_sysvq0asl(result_12);
      NI64 X60Qlf_13 = X60Qlf_11;
      {
        while (X60Qlf_13 < X60Qlf_12){
          {
            putQ_9_sysvq0asl((&result_12), X60Qlf_13, x_1[X60Qlf_13]);}
          inc_1_Irn1g7r1_aif7a4qfr((&X60Qlf_13));}}
      whileStmtLabel_1: ;}
    forStmtLabel_0: ;}
  return result_12;}
void X60Qini_0_str7j0ifg(void){
  if (X60QiniGuard_0_str7j0ifg){
    return;}
  X60QiniGuard_0_str7j0ifg = NIM_TRUE;
  X60Qini_0_sysvq0asl();
  X60Qini_0_assy765wm();
