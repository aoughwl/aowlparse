...
typedef struct WideCStringObj_0_wid623gv{
  NI64 bytes_0;
  NI16* data_0;}
WideCStringObj_0_wid623gv;
extern void X60Qini_0_sysvq0asl(void);
NB8 X60QiniGuard_0_wid623gv;
void X60Qini_0_wid623gv(void){
  if (X60QiniGuard_0_wid623gv){
    return;}
  X60QiniGuard_0_wid623gv = NIM_TRUE;
  X60Qini_0_sysvq0asl();}
