...
typedef NU8 PathComponent_0_osc4bsu0d1;

#define pcFile_0_osc4bsu0d1 ((NU8)IL64(0))
#define pcLinkToFile_0_osc4bsu0d1 ((NU8)IL64(1))
#define pcDir_0_osc4bsu0d1 ((NU8)IL64(2))
#define pcLinkToDir_0_osc4bsu0d1 ((NU8)IL64(3))
typedef struct X60Qt_0_IAtupleSX50athX43omponent0osc4bsu0d1Abool_osc4bsu0d1{
  PathComponent_0_osc4bsu0d1 fld_0;
  NB8 fld_1;}
X60Qt_0_IAtupleSX50athX43omponent0osc4bsu0d1Abool_osc4bsu0d1;
...
typedef struct X60Qt_0_IAtupleSX45rrorX43ode0sysvq0aslAbool_osc4bsu0d1{
  ErrorCode_0_sysvq0asl fld_0;
  NB8 fld_1;}
X60Qt_0_IAtupleSX45rrorX43ode0sysvq0aslAbool_osc4bsu0d1;
...
extern NC8* toCString_0_sysvq0asl(string_0_sysvq0asl* s_62);
...
NB8 X60QiniGuard_0_osc4bsu0d1;
NB8 fileExists_0_osc4bsu0d1(string_0_sysvq0asl filename_0){
  NB8 result_3;
  struct stat res_0 = (struct stat){
    .st_dev = ((NU64)0ull), .st_ino = ((NU64)0ull), .st_size = ((NI64)IL64(0)), .st_mode = ((NU32)0ull), .st_mtime = ((NI64)IL64(0)), .st_mtim = (struct timespec){
      .tv_sec = ((NI64)IL64(0)), .tv_nsec = ((NI64)IL64(0))}}
  ;
  string_0_sysvq0asl filename_1 = nimStrDup(filename_0);
  NB8 X60Qx_12;
  NC8* X60Qx_13 = toCString_0_sysvq0asl((&filename_1));
  int X60Qx_14 = stat(X60Qx_13, (&res_0));
  if (((NI32)IL64(0)) <= X60Qx_14){
    NB8 X60Qx_15 = S_ISREG(res_0.st_mode);
    X60Qx_12 = X60Qx_15;}
  else {
    X60Qx_12 = NIM_FALSE;}
  result_3 = X60Qx_12;
  nimStrDestroy(filename_1);
  return result_3;
  nimStrDestroy(filename_1);
  return result_3;
  nimStrDestroy(filename_1);
  return result_3;}
void X60Qini_0_osc4bsu0d1(void){
  if (X60QiniGuard_0_osc4bsu0d1){
    return;}
  X60QiniGuard_0_osc4bsu0d1 = NIM_TRUE;
  X60Qini_0_sysvq0asl();
  X60Qini_0_osezuyu63();
  X60Qini_0_syn1lfpjv();
  X60Qini_0_assy765wm();
