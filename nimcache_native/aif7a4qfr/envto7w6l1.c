...
__thread seq_0_Ixdx2fh1_aif7a4qfr environment_0_envto7w6l1;
NB8 X60QiniGuard_0_envto7w6l1;
static inline void dec_1_I2mwrey1_envto7w6l1(NI64* x_8){
  (*x_8) = ((NI64)((*x_8) - ((NI64)IL64(1))));}
void X60Qini_0_envto7w6l1(void){
  if (X60QiniGuard_0_envto7w6l1){
    return;}
  X60QiniGuard_0_envto7w6l1 = NIM_TRUE;
  X60Qini_0_sysvq0asl();
  X60Qini_0_str7j0ifg();
  X60Qini_0_osezuyu63();
  eQwasMoved_1_I5vdnla_aif7a4qfr((&environment_0_envto7w6l1));}
static inline void eQwasMoved_1_I5vdnla_aif7a4qfr(seq_0_Ixdx2fh1_aif7a4qfr* s_11){
  (*s_11).len_0 = IL64(0);
  (*s_11).data_0 = NIM_NIL;}
