...
typedef struct PathIter_0_patta6rli{
  NI64 i_0;
  NI64 prev_0;
  NB8 notFirst_0;}
PathIter_0_patta6rli;
...
NB8 X60QiniGuard_0_patta6rli;
void X60Qini_0_patta6rli(void){
  if (X60QiniGuard_0_patta6rli){
    return;}
  X60QiniGuard_0_patta6rli = NIM_TRUE;
  X60Qini_0_sysvq0asl();
  X60Qini_0_ossk30t39();}
