...
#include <signal.h>
#include <spawn.h>
typedef struct X60Qt_0_IAarrayAcS8ZS256_pososrh1q1{
  NC8 a[IL64(256)];}
X60Qt_0_IAarrayAcS8ZS256_pososrh1q1;
typedef N_NOCONV_PTR(void,  X60Qt_0_IAiS32AimportcSUintUZZSEAnoconvZAfalseZAR31_pososrh1q1)(int);
extern void X60Qini_0_sysvq0asl(void);
NB8 X60QiniGuard_0_pososrh1q1;
void X60Qini_0_pososrh1q1(void){
  if (X60QiniGuard_0_pososrh1q1){
    return;}
  X60QiniGuard_0_pososrh1q1 = NIM_TRUE;
  X60Qini_0_sysvq0asl();}
